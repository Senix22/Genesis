...
import com.example.genesis.remote.SlidesDataModel

class ImageSlideAdapter(private val context: Context, private var imageList: List<SlidesDataModel>) : PagerAdapter() {
